...
import 'package:test1/mainScreens/rate_driver_screen.dart';
import 'package:test1/widgets/ListofTech.dart';
...
import 'select_nearest_active_technician_screen.dart';
  ...
  createActiveNearByDriverIconMarker() {
    if (activeNearbyIcon == null) {
      ...
      BitmapDescriptor.fromAssetImage(
              imageConfiguration, "images/mechanics.png")
          .then((value) {
